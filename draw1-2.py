...
# 绘制a
rects1 = plt.bar(index, a_t, bar_width, color='red', label=names[0])
# 绘制b
rects2 = plt.bar(index + bar_width, b_t, bar_width, color='green', label=names[1])
# 绘制c
rects3 = plt.bar(index + bar_width * 2, c_t, bar_width, color='blue', label=names[1])
# X轴标题
